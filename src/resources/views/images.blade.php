            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <!--"-->
                        <form  action="{{url('dashboard/gallery/storeImages')}}" id="fm_dropzone_main"   enctype="multipart/form-data" method="POST">
                            @csrf
        ...
        <script>
            ...
            $(function () {
                fm_dropzone_main = new Dropzone("#fm_dropzone_main", {
                    ...
                    params: {
                        gallery_id: galleryId // Add gallery ID to the parameters
                    },
                    init: function() {
                ...
                $("body").on("click", "ul.files_container .fm_file_sel", function() {
                    ...
                    $("#EditFileModal #delFileBtn").attr("href","{{url('dashboard/gallery/destroyImage')."/"}}"+upload);
            ...
            function loadUploadedFiles() {
                ...
                $.ajax({
                    dataType: 'json',
                    url: "{{ url('dashboard/gallery/image') }}",
            ...
            function formatFile(upload,data) {
                ...
                return `<li><img src="{{url('sliders/1719124236.png')}}"></li>`
            }
        </script>
